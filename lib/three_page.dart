...
Widget getItem(BuildContext context, int index){
  ...
  var avatars = List.generate(subject['casts'].length, (int i) => Container(
    width: 50,
    margin: EdgeInsets.only(left: i.toDouble() == 0.0 ? 0.0 : 10.0),
  ...
  return new GestureDetector(
      onTap: (){
        Navigator.push(
            context,
            new MaterialPageRoute(builder: (context) => MovieDetail(data: subject))
        );
      },
      child: Container(
        height: 190,
        child: Card(
          color: AppColors.color_fffafafa,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('${subject['title']}', style: textStyle2,
                      maxLines: 1,),
